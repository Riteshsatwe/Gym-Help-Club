...
<body>
	...
	%>
	<script>
		alert("Enquiry Data has been Updated..");
	...
	<script>
		...
		window.location.assign("editEnquiry.jsp");
	</script>
	<%
		}
	%>
	...
	<%
		...
		try {
			...
			ResultSet rs = st.executeQuery("select * from enquiry where id=" + id + "");
			while (rs.next()) {
				name = rs.getString(2);
	%>

	<h3 class="text-center text-danger">Edit Enquiry Data</h3>
	<br>
	<div class="container">
		...
		<div class="col-lg-9 m-auto d-block">
			<div class="card">
				<div class="card-body">
					...
					<form action="editEnquiryAction.jsp" method="post"
